        ...
        <div className="App bg-light">
            ...
            <div className='content'>
                    ...
                    <div className="container col-xxl-8 px-4 py-5">
                        <div className="row flex-lg-row-reverse align-items-center g-5 py-5">
                            ...
                            <div className="col-lg-6">
                                <h1 className="display-5 fw-bold lh-1 mb-3">No more conflict of event</h1>
                                <p className="lead">
                                    Sync all your Google calendars together and save yourself trouble.
                ...
                <div className='container'>
                    <div className="row g-4 my-5 py-5 row-cols-1 row-cols-lg-3">
                        <div className="feature col">
                            <h2>Unlimited Calendars</h2>
                            <p className='lead'>No limit on the number of accounts and calendars you want to sync together</p>
                        </div>
                        <div className="feature col">
                            <h2>Synchronized in seconds</h2>
                            <p className='lead'>When an event is created or modified, it is updated on all calendars in a matter of seconds!</p>
                        </div>
                        <div className="feature col">
